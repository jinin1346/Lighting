...
<body>
    <!-- 모달창을 여는 버튼 -->
    <button id="openModalButton">아이디 찾기</button>

    <!-- 모달창 내용 -->
    <div id="modal" class="modal">
        <div class="modal-content">
         <img alt="로고" src="images/logo_세로.png" id="logo" style="display: block; margin: 0 auto 20px; max-width: 200px;">
        
            <span class="close-button">&times;</span>
            <form action="아이디 찾기 로직 URL" method="POST">
